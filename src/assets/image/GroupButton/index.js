...
const GroupButton = (props) => {
    return (
        <svg {...props} xmlns="http://www.w3.org/2000/svg"  width="47.902" height="122.164" viewBox="0 0 47.902 122.164">
        <defs>
        ...
        <g id="Group_930" data-name="Group 930" transform="translate(-1803.879 -681.835)">
          <g id="Side_Buttons" data-name="Side Buttons" transform="translate(1807.352 684.601)">
            ...
            <path id="Path_377" data-name="Path 377" d="M16.451,0A16.451,16.451,0,1,1,0,16.451,16.451,16.451,0,0,1,16.451,0Z" transform="translate(4.027 86.495)" fill="#fff"/>
            <rect id="Rectangle_1467" data-name="Rectangle 1467" width="40.956" height="40.956" rx="20.478" transform="translate(0)" fill="#fff" opacity="0.36"/>
            ...
            <g id="support" transform="translate(12.234 94.088)">
          ...
          <g id="mail" transform="translate(1819.031 739.538)">
