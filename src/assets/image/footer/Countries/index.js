const Countries = () => {
  return (
    <svg id="Group_1106" data-name="Group 1106" xmlns="http://www.w3.org/2000/svg" width="145" height="52" viewBox="0 0 145 52">
  <rect id="Rectangle_1853" data-name="Rectangle 1853" width="145" height="52" rx="3" fill="#fff"/>
  <text id="English" transform="translate(43 16)" fill="#2699fb" font-size="15" font-family="SegoeUI, Segoe UI"><tspan x="0" y="16">English</tspan></text>
  <path id="Path_339" data-name="Path 339" d="M848.953,876.7l8.479,8.479,8.479-8.479" transform="translate(-733.076 -854.368)" fill="none" stroke="#2699fb" stroke-linecap="round" stroke-width="3"/>
  <g id="Web" transform="translate(10.845 13.95)">
